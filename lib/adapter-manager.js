...
class AdapterManager {
  ...
  buildHeaders(rawHeaders, paneItem) {
    ...
    return augmentAdapterItems(rawHeaders, paneItem, adapter, traceByVisibility, maxDepth);
  }
}
...
function augmentAdapterItems(items, paneItem, adapter, traceByVisibility, maxDepth, revel = 1) {
