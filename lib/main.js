...
module.exports = {
  ...
  activate() {
    ...
    // The opener/deserializer contract exposes a pane item immediately. Build
    // only that lightweight host now; parser, adapters, marker layers and the
    // existing-editor sweep are still scheduled below.
